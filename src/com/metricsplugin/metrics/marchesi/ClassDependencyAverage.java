 ...
 * Calcula a média de dependência de classes.
 * Chamada OA5.
 * @author bruno
 * São consideradas dependencias, todos os relacionamentos exceto herança.
 */
@MetricChart
public class ClassDependencyAverage extends AbstractMetric{
	...
	public void calculateMetric() {
		...
		if(diagram instanceof UMLClassDiagram){
			...
			media=cont/umlDiagram.getNodes().size();
			setResultado(media);
